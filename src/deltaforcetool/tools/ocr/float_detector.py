...
class FloatDetector:
  ...
  def extract_floats_from_region(self, image: Image.Image, region: Tuple[int, int, int, int]) -> List[DetectionResult]:
  ...
  def detect_and_save(self, image: Image.Image, region: Tuple[int, int, int, int]) -> List[DetectionResult]:
